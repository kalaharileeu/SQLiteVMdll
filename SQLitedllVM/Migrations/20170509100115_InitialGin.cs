...
{
    public partial class InitialGin : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsernumberID1 = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPoints", x => x.PointId);
                    table.ForeignKey(
                        name: "FK_UserPoints_Users_UserForeignKey",
                        column: x => x.UserForeignKey,
                        principalTable: "Users",
                        principalColumn: "UsernumberID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserPoints_Users_UsernumberID1",
                        column: x => x.UsernumberID1,
                        principalTable: "Users",
                        principalColumn: "UsernumberID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPoints_UserForeignKey",
                table: "UserPoints",
                column: "UserForeignKey");

            migrationBuilder.CreateIndex(
                name: "IX_UserPoints_UsernumberID1",
                table: "UserPoints",
                column: "UsernumberID1");
        }
